...
const BEVEL = {
  borderTop: '1.5px solid rgba(255,184,0,0.40)',
  borderLeft: '1px solid rgba(255,184,0,0.20)',
  borderRight: '1.5px solid rgba(0,0,0,0.50)',
  borderBottom: '2px solid rgba(0,0,0,0.72)',
  boxShadow:
    'inset 0 1px 0 rgba(255,255,255,0.10), inset 0 -2px 6px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.03), 0 8px 32px -8px rgba(255,184,0,0.18), 0 4px 16px rgba(0,0,0,0.55)',
} as const;
