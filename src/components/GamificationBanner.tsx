          ...
          <div className="flex items-start justify-between gap-2 mb-2.5">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5">
                <h2 className="font-black text-sm leading-tight"
                  style={{
                ...
                <span className="text-3xs px-1 py-px rounded-full font-extrabold"
            ...
            <div className="shrink-0 flex items-center gap-1 px-1.5 py-0.5 rounded-md"
              ...
              <span className="text-3xs font-bold" style={{ color: 'var(--emerald)' }}>Live</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5">
            <div className="flex-1 flex items-center gap-1.5 px-2 py-1.5 rounded-lg"
              ...
              <div className="min-w-0">
                <p className="text-2xs font-black leading-none" style={{ color: '#FF8E53' }}>
            ...
            <div className="flex-1 flex items-center gap-1.5 px-2 py-1.5 rounded-lg"
              ...
              <div className="min-w-0">
                <p className="text-2xs font-black leading-none" style={{ color: '#FFD200' }}>
            ...
            <div className="flex-1 flex items-center gap-1.5 px-2 py-1.5 rounded-lg"
              ...
              <div className="min-w-0">
                <p className="text-2xs font-black leading-none" style={{ color: '#c4b5fd' }}>
