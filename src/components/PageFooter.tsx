...
export function PageFooter() {
  return (
    <footer className="px-4 pt-6 pb-4">
      {/* Брендовый блок (лого + градиентное имя) убран: футер живёт на первом
          экране, а второй логотип рядом с шапкой только дублировал акцент.
          Название продукта остаётся в дисклеймере и копирайте ниже. */}
