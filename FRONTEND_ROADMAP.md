...
| # | Проблема | Статус |
|---|----------|--------|
| 1-9 | Все 9 пунктов предыду��его техдолга | ✅ Закрыты |
...
| — | Per-game система акцента (рампа `--ga-*`) | 🚧 D1 готов 24.06 (8 ступеней `--ga-100..900`, дефолт=янтарь); D2 — замена ~40 хардкодов в `lottery-cards.css` |
